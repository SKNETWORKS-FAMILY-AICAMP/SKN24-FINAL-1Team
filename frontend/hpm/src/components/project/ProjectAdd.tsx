...
export default function ProjectAdd({ className = "", ...props }: ProjectAddProps) {
  return (
    <div
      {...props}
      className={`${DESIGN.BACKGROUND_COLORS.white} ${DESIGN.RADIUS_SIZES.xl} cursor-pointer hover:shadow-md hover:border-[#623FB5] transition border-dashed ${DESIGN.BORDER_COLORS.gray} flex items-center justify-center w-[352px] min-h-[224px] ${className}`}
    >
